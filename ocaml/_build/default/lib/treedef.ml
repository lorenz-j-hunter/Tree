...
class tree: tree_type =
  object (self)
    ...
    method insert data desired_depth desired_d = Tree.insert data desired_depth desired_d
    method remove desired_depth desired_d = Tree.remove desired_depth desired_d
